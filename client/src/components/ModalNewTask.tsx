...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!status) {
      console.log(status);
      console.error("Status is not set correctly.");
      return;
    }
    await createTask({
      title,
          ...
          <select
            ...
            onChange={(e) => {
              ...
              const mappedEnumValue =
                statusDisplayToEnumMap[
                  selectedDisplayValue as keyof typeof statusDisplayToEnumMap
                ];
              setStatus(mappedEnumValue);
            }}
          >
