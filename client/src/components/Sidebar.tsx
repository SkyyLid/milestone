    ...
    <div className={SidebarClassNames + " scrollbar-hide"}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="boder-y-[1.5px] flex items-center gap-5 border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image
            src="https://pm-s3-bucket-imagez.s3.ap-south-1.amazonaws.com/logo.png"
            alt="logo"
            width={40}
            height={40}
          />
        ...
        <div className="flex w-full items-center ">
                  <div className="align-center flex size-9 justify-center">
                    {!!currentUserDetails?.profilePictureUrl 
                      ?(
                        <Image
                                  src={`https://pm-s3-bucket-imagez.s3.ap-south-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
